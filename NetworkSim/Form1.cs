		...
		private void Form1_Load(object sender, EventArgs e)
		{
			...
			server1.SetProxy(
				@"192.168.1.2;192.168.1.131;pass
				  192.168.1.2;192.168.1.132;deny
				  any;any;deny");

			pc1.SetIP("192.168.1.2/25");
			pc1.SetGateway("192.168.1.1");

			pc2.SetIP("192.168.1.131/25");
			pc2.SetGateway("192.168.1.130");

			pc3.SetIP("192.168.1.132/25");
			...
			pc1.SendPackage(new NetworkComponents.Package("192.168.1.140"));
		}
	}
}
